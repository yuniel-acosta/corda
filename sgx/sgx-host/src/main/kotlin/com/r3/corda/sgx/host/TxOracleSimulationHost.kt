...
class AMQPHandlerHostSimulation<U : Any, V : Any>(
        serviceHub: ServiceHub,
        enclaveFile: File,
        epidConfiguration: EpidAttestationHostConfiguration)
    : Function<U, V> {

    val enclaveIdentity: EnclaveAttestedIdentity
        get() = EnclaveAttestedIdentity(measurement, EnclaveIdentity.EnclaveMode.SIMULATION)

    private val enclavelthostHandler = EnclaveletHostHandler(epidConfiguration)
