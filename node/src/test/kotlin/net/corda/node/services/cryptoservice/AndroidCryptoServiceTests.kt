...
class AndroidCryptoServiceTests {

    companion object {
    //TODO LOOK AT ULTIMACOCRYPTOSERVINTEGRATION
        val config = AndroidCryptoService.AndroidCryptoServiceConfig("", 1, "", "", "")
    ...
    fun `BCCryptoService generate key pair and sign both data and cert`() {
        val cryptoService = AndroidCryptoService(config)
    ...
    private fun generateKeyAndSignForScheme(cryptoService: AndroidCryptoService, signatureScheme: SignatureScheme) {
