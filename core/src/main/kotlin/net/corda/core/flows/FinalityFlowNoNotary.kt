...
class FinalityFlowNoNotary private constructor(val transaction: SignedTransaction,
                                       ...
                                       private val doNotNotarise: Boolean = false) : FlowLogic<SignedTransaction>() {
...
//    ) : this(transaction, emptyList(), progressTracker, sessions, true)
    ...
    constructor(
            transaction: SignedTransaction,
            sessions: Collection<FlowSession>,
            doNotNotarise: Boolean,
            progressTracker: ProgressTracker = tracker()
    ) : this(transaction, emptyList(), progressTracker, sessions, true, statesToRecord = ONLY_RELEVANT, doNotNotarise = doNotNotarise)
    ...
    override fun call(): SignedTransaction {
        ...
        val notarised = notariseAndRecord(doNotNotarise = doNotNotarise)
