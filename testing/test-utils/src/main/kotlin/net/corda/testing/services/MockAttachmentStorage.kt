...
//        }
        return importAttachmentInternal(jar, uploader)
    }
...
//    }
    ...
    private fun importAttachmentInternal(jar: InputStream, uploader: String, attachmentId: AttachmentId? = null, signers: List<PublicKey> = emptyList()): AttachmentId {
...
//                    }
            _files[sha256] = Pair(baseAttachment, bytes)
        }
        return sha256
    }
