...
import net.corda.core.crypto.PrivacySalt
...
private val attachmentTrustedCache: MutableMap<AttachmentAttributeKey, Boolean> = createSimpleCache<AttachmentAttributeKey, Boolean>(100)
        .toSynchronised()
