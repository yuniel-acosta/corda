package net.corda.corenode.serialization

import net.corda.core.DeleteForDJVM
import net.corda.core.MovedPackage
import net.corda.core.node.ServiceHub
import net.corda.core.serialization.CordaSerializable
import net.corda.corenode.serialization.SingletonSerializationToken.Companion.singletonSerializationToken
...
@DeleteForDJVM
@CordaSerializable
@MovedPackage("net.corda.core.serialization", "net.corda.corenode.serialization")
