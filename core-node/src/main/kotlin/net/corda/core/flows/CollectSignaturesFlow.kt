...
import net.corda.corenode.identity.groupPublicKeysByWellKnownParty
...
class CollectSignaturesFlow @JvmOverloads constructor(val partiallySignedTx: SignedTransaction,
    ...
    @JvmOverloads
    constructor(partiallySignedTx: SignedTransaction, sessionsToCollectFrom: Collection<FlowSession>, progressTracker: ProgressTracker = tracker()) : this(partiallySignedTx, sessionsToCollectFrom, null, progressTracker)
