    ...
    val invocationContext: InvocationContext
        get() {
            ...
            when (this) {
                ...
                is Peer -> origin = InvocationOrigin.Peer(this.party.name)
                is Service -> origin = InvocationOrigin.Service(this.serviceClassName, unknownName)
                Shell -> origin = InvocationOrigin.Shell
                is Scheduled -> origin = InvocationOrigin.Scheduled(this.scheduledState)
            }
