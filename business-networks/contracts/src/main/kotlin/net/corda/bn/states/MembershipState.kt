...
data class MembershipState(
    ...
    fun canModifyRelationship() = AdminPermission.CAN_MODIFY_RELATIONSHIP in permissions()
...
enum class AdminPermission : BNPermission {
    ...
    /**
     * Enables member to modify memberships' associated [RelationshipState]'s groups.
     */
